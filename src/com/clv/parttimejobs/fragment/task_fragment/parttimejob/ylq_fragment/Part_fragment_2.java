package com.clv.parttimejobs.fragment.task_fragment.parttimejob.ylq_fragment;
...
import com.clv.parttimejobs.fragment.task_fragment.parttimejob.dsh_fragment.Part_fragment_1.MyThread1;
...
public class Part_fragment_2 extends Fragment implements orderfragment_interface{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View viewRoot = inflater.inflate(R.layout.partjob_fragment_3, null);
		context=this.getActivity();
		listview = (ListView) viewRoot.findViewById(R.id.listview_partjob_ylq);

	    daishenhe = new ArrayList<PartJobBean>();
		myListpaerjobAdapter = new My_order_ylq_Adapter(
		...
		public class MyThread1 implements Runnable {
			...
			public void run() {
				...
				try {
					...
					URL url = new URL("http://115.159.64.167:8080/ssm/user/parttimes/getPartTimeAdmission");
