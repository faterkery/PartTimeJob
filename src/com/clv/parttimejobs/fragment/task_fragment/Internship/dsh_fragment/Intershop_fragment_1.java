package com.clv.parttimejobs.fragment.task_fragment.Internship.dsh_fragment;
...
public class Intershop_fragment_1 extends Fragment implements orderfragment_interface{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View viewRoot = inflater.inflate(R.layout.intershop_fragment, null);

		listview = (ListView) viewRoot
				.findViewById(R.id.listview_intershop_dsh);

		daishenhe = new ArrayList<PartJobBean>();
		My_order_dsh_Adapter myListpaerjobAdapter = new My_order_dsh_Adapter(
