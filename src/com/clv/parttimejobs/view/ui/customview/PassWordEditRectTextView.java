...
public class PassWordEditRectTextView extends EditText {
	...
	private MyWalleTxPopWindowListener listener;
	
	public PassWordEditRectTextView(Context context) {
		this(context, null);
	}

	public PassWordEditRectTextView(Context context, AttributeSet attrs) {
	...
	private void drawRoundRect(Canvas canvas) {
		...
		canvas.drawRect(r1,  mBorderPaint);
		RectF r2 = new RectF(); // Rect对象
		r2.left = 0; // 左边
		r2.top = 0; // 上边
		r2.right = mWidth; // 右边
		r2.bottom = mHeight; // 下边
		canvas.drawRect(r2,  mBorderKuangPaint);
	}
...
//			;
	...
	public void setListener(MyWalleTxPopWindowListener listener){
