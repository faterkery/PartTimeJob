...
public class ExpandView_shijian extends FrameLayout {
	...
	public ExpandView_shijian(Context paramContext) {
	...
	private void initExpandView() {
		LayoutInflater.from(getContext()).inflate(
				R.layout.news_rey_select_shijian, this, true);
	...
	public void initView(){
		...
		button1 =(Button) findViewById(R.id.buttons__01);
		button2 =(Button) findViewById(R.id.buttons__02);
		button3 =(Button) findViewById(R.id.buttons__03);
		imageview1 = (ImageView) findViewById(R.id.imgs__01);
		imageview2 = (ImageView) findViewById(R.id.imgs__02);
		imageview3 = (ImageView) findViewById(R.id.imgs__03);
	...
	private class InnerOnclickListener implements OnClickListener{
		...
		public void onClick(View v) {
			...
			switch(v.getId()){
			case R.id.buttons__01:{hideImg();
				imageview1.setVisibility(View.VISIBLE);
				collapse();
				break;
			}
			case R.id.buttons__02:{hideImg();
				imageview2.setVisibility(View.VISIBLE);
				collapse();
				break;
			}
			case R.id.buttons__03:{hideImg();
