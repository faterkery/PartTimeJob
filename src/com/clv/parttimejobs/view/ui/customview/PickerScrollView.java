...
public class PickerScrollView extends View {  
    ...
    public void setOnSelectListener(int position,onSelectListener listener) {
    ...
    private void performSelect() {  
        if (mSelectListener != null)  
            mSelectListener.onSelect(position,mDataList.get(mCurrentSelected));  
    }  
    ...
    {
    	int width=getMeasuredHeight()/6;
    	// 绘制两条线 
        canvas.drawLine(0, mViewHeight*42/100, mViewWidth, mViewHeight*42/100, mPaint);
        canvas.drawLine(0, mViewHeight*42/100+width, mViewWidth, mViewHeight*42/100+width, mPaint);
    }
    	/** 
     * @param canvas 
     * @param position 
    ...
    public interface onSelectListener {  
        void onSelect(int position,Pickers pickers);  
    }  
}  