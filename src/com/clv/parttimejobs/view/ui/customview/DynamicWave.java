...
import com.clv.parttimejobs.util.ecutescreen.UiUtils;
...
public class DynamicWave extends View {
	...
	// 波纹颜色
	private static final int WAVE_PAINT_COLOR = 0x00f0ff;
	// y = Asin(wx+b)+h
	...
	public DynamicWave(Context context, AttributeSet attrs) {
		...
		// 设置画笔颜色
		mWavePaint.setColor(Color.parseColor("#448aca"));
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < mTotalWidth; i++) {
			...
			// 绘制第一条水波纹
			canvas.drawLine(i, 0, i, mTotalHeight - mResetOneYPositions[i]
					- 180, mWavePaint);

			// 绘制第二条水波纹
			canvas.drawLine(i, 0, i, mTotalHeight - mResetTwoYPositions[i]
					- 180, mWavePaint);
		}
