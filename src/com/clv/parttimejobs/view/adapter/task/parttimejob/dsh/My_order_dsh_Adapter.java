package com.clv.parttimejobs.view.adapter.task.parttimejob.dsh;
...
public class My_order_dsh_Adapter extends BaseAdapter {
	...
	public My_order_dsh_Adapter(Context context, List<PartJobBean> list,orderfragment_interface listener) {
		super();
		this.list = list;
