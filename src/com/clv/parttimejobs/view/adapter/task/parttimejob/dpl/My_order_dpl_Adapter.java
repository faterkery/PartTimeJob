...
public class My_order_dpl_Adapter extends BaseAdapter {
	...
	public My_order_dpl_Adapter(Context context, List<PartJobBean> list,orderfragment_interface listener) {
		super();
		this.list = list;
