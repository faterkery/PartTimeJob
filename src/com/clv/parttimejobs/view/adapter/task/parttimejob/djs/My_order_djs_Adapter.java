package com.clv.parttimejobs.view.adapter.task.parttimejob.djs;
...
public class My_order_djs_Adapter extends BaseAdapter {
	...
	public My_order_djs_Adapter(Context context, List<PartJobBean> list,orderfragment_interface listener) {
		super();
		this.list = list;
	...
	public View getView(final int position, View view, ViewGroup viewpartents) {
		...
		view = inflater.inflate(R.layout.item_order_dsh_list, null);
...
//		holder.tvePeopleName.setText(n.get());
//		holder.tvetel.setText(n.getPeople_tel());
	...
	class Holder {
		...
		public Holder(View view){
			...
			button =(Button)view.findViewById(R.id.dsh_button_to);
		}
	}
